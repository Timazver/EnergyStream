...
//            addressDataLbl.topAnchor.constraint(equalTo: addressTitleLbl.topAnchor, constant: 10).isActive = true
            ...
            ticketNumLbl.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 30)
            ...
            dateLbl.rightAnchor.constraint(equalTo: headerView.rightAnchor, constant: -50).isActive = true
